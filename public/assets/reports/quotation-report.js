$(document).on("submit", ".quotationSubmission", function (e) {
    e.preventDefault();
...
function updateExportLinks() {
    var formData = new FormData(document.querySelector(".quotationSubmission"));
    ...
    var excelUrl = "/quotation-report-export-excel?" + queryString;
    $("#excelExport").attr("href", excelUrl);

    // Update PDF export link
    var pdfUrl = "/quotation-report-export-pdf?" + queryString;
