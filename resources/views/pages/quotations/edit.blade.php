                        ...
                        <div class="row">
                                 ...
                                 <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" required
                                                    parsley-type="text" readonly name="quotation_no" value="{{ $quotation->quotation_no }}" placeholder=""/>
                                        </div>
                                    </div>
                            </div>
                              <div class="col-lg-3">
                                 <div class="form-group">
                                        ...
                                        <div>
                                            <input type="date" class="form-control" required
                                                    parsley-type="text" name="quotation_date" value="{{ $quotation->quotation_date }}" placeholder=""/>
                                        </div>
                                    </div>
                            </div>
                            <div class="col-lg-3">
                                            ...
                                            <select class="form-control js-example-basic-single" name="customer_id" id="customer_id">
                                                ...
                                                @if($customers = App\Models\Customer::get())
                                                    @foreach ($customers as $customer)
                                                        <option value="{{ $customer->id }}" @if($quotation->customer_id == $customer->id) selected @endif>{{ $customer->customer_name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                            ...
                            <div class="col-lg-3">
                                 <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" required
                                                    parsley-type="text" name="mode_terms_of_payment" value="{{ $quotation->mode_terms_of_payment }}" placeholder=""/>
                                        </div>
                                    </div>
                            </div>
                             <div class="col-lg-3">
                                 <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" required
                                                    parsley-type="text" name="buyer_reference_order_no" value="{{ $quotation->buyer_reference_order_no }}" placeholder=""/>
                                        </div>
                                    </div>
                            </div>
                            <div class="col-lg-3">
                                 <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" required
                                                    parsley-type="text" name="other_references" value="{{ $quotation->other_references }}" placeholder=""/>
                                        </div>
                                    </div>
                            </div>
                            <div class="col-lg-3">
                                 <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" required
                                                    parsley-type="text" name="dispatch_through" value="{{ $quotation->dispatch_through }}" placeholder=""/>
                                        </div>
                                    </div>
                            </div>
                             <div class="col-lg-3">
                                 <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" required
                                                    parsley-type="text" name="destination" value="{{ $quotation->destination }}" placeholder=""/>
                                        </div>
                                    </div>
                            </div>
                            <div class="col-lg-6">
                                 <div class="form-group">
                                        ...
                                        <div>
                                            <textarea class="form-control" name="terms_of_delivery">{{ $quotation->terms_of_delivery }}</textarea>
                                 ...
                                 <div class="form-group">
                                        ...
                                        <div>
                                            <select class="form-control" name="customer_type" id="customer_type">
                                                ...
                                                <option value="mrp_customer" @if($quotation->customer_type == 'mrp_customer') selected @endif>MRP Customer</option>
                                                <option value="wholesale_customer" @if($quotation->customer_type == 'wholesale_customer') selected @endif>Wholesale Customer</option>
                                            </select>
                                 ...
                                 <div class="form-group">
                                        ...
                                        <div>
                                            <select class="form-control" name="quotation_type" id="quotation_type">
                                                <option value="">-- Choose Option --</option>
                                                <option value="b2b" @if($quotation->quotation_type == 'b2b') selected @endif>B2B</option>
                                                <option value="retail" @if($quotation->quotation_type == 'retail') selected @endif>Retail</option>
                                            </select>
                            ...
                            <div class="col-lg-12">
                                <table class="table table-bordered" id="stagesTable">
                                    ...
                                    <tbody>
                                        ...
                                        @if($quotation)
                                            @foreach ($quotation->quotationProducts as $quotationProducts)
                                            <tr>
                                            <td>
