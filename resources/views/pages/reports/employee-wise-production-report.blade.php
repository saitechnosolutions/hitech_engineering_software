    ...
    <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                                        <label>Team</label>
                                                                        <div>
                                                                            <select class="form-control js-example-basic-single" name="teamName" id="teamName" style="width:350px">
                                                                                <option value="">-- Choose Team --</option>
                                                                                <option value="ss_fabrication_team">SS Fabrication Team</option>
                                                                                <option value="ms_fabrication_team">MS Fabrication Team</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                        </div>
                        ...
                        <div class="col-12 p-0">
                            <div class="card m-b-30">
                                <div class="card-header">
                                    <div style="display:flex;justify-content:space-between">
                                        <h4 class="mt-0 header-title">Employee Wise Production Report</h4>
                                    </div>
                                </div>
...
{{ $dataTable->scripts(attributes: ['type' => 'module']) }}
            <script src="/assets/reports/employee-report.js"></script>
@endpush
