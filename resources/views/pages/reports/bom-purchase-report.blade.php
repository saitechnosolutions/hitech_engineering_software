...
<div class="row mt-3">
     <div class="col-12">
                            <div class="card m-b-30">
                                ...
                                <div class="card-body">
                                    <form  class="reportSubmission" action="{{ route('bomPurchaseReportFilter') }}" id="bomPurchaseReportFilter">
                                        @csrf
                                    <div class="row">
                                                                  ...
                                                                  <div class="form-group">
                                                                        ...
                                                                        <div>
                                                                            <select class="form-control js-example-basic-single" name="type" id="type" style="width:350px">
                        ...
                        <div class="col-12">
                            <div class="card m-b-30">
                                <div class="card-header">
                                    <div style="display:flex;justify-content:space-between">
                                        <h4 class="mt-0 header-title">BOM Purchase Report</h4>
                                    </div>
                                </div>
...
<script src="/assets/reports/bom-purchase-report.js"></script>
@endpush
