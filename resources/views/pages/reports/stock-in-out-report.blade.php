    ...
    <div class="row mt-3">
        <div class="col-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form class="stockInOutSubmission" action="{{ route('stockInOutReportFilter') }}"
                        id="stockInOutReportFilter">
                        @csrf
                        <div class="row">
        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <div style="display:flex;justify-content:space-between">
                        <h4 class="mt-0 header-title">Stock IN - OUT</h4>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script src="/assets/reports/stock-in-out-report.js"></script>
