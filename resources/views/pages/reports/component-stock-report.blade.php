    ...
    <div class="row mt-3">
        <div class="col-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form class="componentstockSubmission" action="{{ route('componentstockReportFilter') }}"
                        id="componentstockReportFilter">
                        @csrf
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select class="form-control js-example-basic-single" name="productIds"
                                            ...
                                            @if($product = App\Models\ProductComponents::get())
                                                @foreach ($product as $products)
                                                    <option value="{{ $products->id }}">{{ $products->component_name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <div style="display:flex;justify-content:space-between">
                        <h4 class="mt-0 header-title">Component Stock Report</h4>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/reports/component-stock-report.js') }}"></script>
@endpush