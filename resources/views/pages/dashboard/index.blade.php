...
@push('scripts')
    ...
    <script>
        function exportToExcel(quotationId) {
            window.location.href = '{{ route("dashboard.export-tl-dashboard-excel") }}?quotation_id=' + quotationId;
        }

        function exportToPDF(quotationId) {
            window.location.href = '{{ route("tl-dashboard-pdf") }}?quotation_id=' + quotationId;
        }
    </script>
    <script src="/assets/dashboard/dashboard-filters.js"></script>
    <script src="/assets/dashboard/dashboard-quote.js"></script>
@endpush
