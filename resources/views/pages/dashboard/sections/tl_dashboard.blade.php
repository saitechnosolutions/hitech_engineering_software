                ...
                @foreach ($quotations as $quotation)
                    ...
                    @if($quotationCount != 0)
                        <div class="card">
                            ...
                            <div id="collapse{{ $quotation->id }}" class="collapse @if($i++ == 1) show @endif"
                                aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="container-fluid p-0 m-0 w-100">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <ul class="list-group">
                                                <li class="list-group-item active bg-success" style="font-size:18px;color:#fff;"
                                                    aria-current="true">
                                                    <div class="row">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-4">
                                                                                <div style="display:flex">
                                                                                    ...
                                                                                    <div class="p-2"
                                                                                        style="line-height:1.3;margin-left:15px;font-size:13px">
                                                                                        <span>{{ $quotationProduct->product->part_number }}</span><br>
                                                                                        <span>{{ $quotationProduct->product->product_name }}</span> /
                                                                                        <span>{{ $quotationProduct->product->variation }}</span><br>
                                                                                        <a href="{{ $quotationProduct->product->data_sheet }}"
                                                                                            download>DATA SHEET</a><br>
                                                                                        <span style="color:#ec1c24"><b>Product Qty :</b>
                                                                                            {{ $quotationProduct->quantity }}</span>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                ...
                                                                                @endphp
                                                                                {{-- @if($boms =
                                                                                App\Models\QuotationProductionStages::with('bom')->where('quotation_id',
                                                                                $quotation->id)->where('product_id',
                                                                                $quotationProduct->product_id)->whereIn('team_id',
                                                                                $teamIds)->where('status', 'pending')->get())
                                                                                <ul class="p-0" style="display:flex;flex-wrap: wrap">
                                                                                    @foreach ($boms as $bom)
                                                                                    <li
                                                                                        style="display:flex;padding:10px;font-size:13px;border-radius:50px;">
                                                                                        {{ $bom?->bom?->bom_name }}
                                                                                    </li>
                                                                                    @endforeach
                                                                                </ul>
                                                                                ...
                                                                                @if(
                                                                                    ...
                                                                                    <ul class="p-0"
                                                                                        style="display:flex;flex-wrap: wrap;list-style-type:circle">
                                                                                        @foreach ($list as $bom)
                                                                                            <li
                                                                                                style="display:flex; padding:10px; font-size:11px; border-radius:10px;
                                                                                                ...
                                                                                                @if($roleName == 'Team Leader - Packing Team' || $roleName == 'Team Leader - Dispatch Team')
                                                                                                    ...
                                                                                                    <div
                                                                                                        style="background-color:{{ $color }};padding:2px 5px;border-radius:5px;color:white">
                                                                                                        <span>R : {{ $receivedCompletedQty }} / A :
                                                                                                            {{ $packingQty }}</span> / <span> T :
                                                                                                            {{ $totqty }}</span> Qty
                                                                                                    </div>
                                                                                                    @php
                                                                                                    ...
                                                                                                    @if($getStageTwoStatus == 'completed' && ($getStageThreeStatus
                                                                                                    == 'pending' || $getStageOneStatus == 'pending'))
                                                                                                    <pre class="badge badge-info"> Received</pre>
                                                                                                    @elseif($getStageTwoStatus == 'completed' && ($getStageOneStatus
                                                                                                    == 'completed' || $getStageThreeStatus == 'completed'))
                                                                                                    ...
                                                                                                    {{-- @if($bomProductionStage?->production_status == "completed")
                                                                                                    &nbsp;
                                                                                                    <pre class="badge badge-info"> Received</pre> @else &nbsp;
                                                                                                    <pre class="badge badge-warning"> Pending</pre> @endif --}}
                                                                                                @else
                                                                                                    @php
                                                                                                        $stageValue = $bom->stage;
                                                                                                        $stage = str_replace("stage_", "", $bom->stage);
                                                                                                    ...
                                                                                                    {{ $bom?->bom?->bom_name }} / {{ $bom?->bom?->bom_unit }} /
                                                                                                    {{ $bom?->bom?->bom_qty }} Qty - &nbsp;<span
                                                                                                        style="color:red">QTY : {{ $bom?->completed_quantity ?? 0 }}
                                                                                                        / {{ $bom->bom_required_quantity }}</span>
                                                                            ...
                                                                            <div class="col-lg-2 text-center">
                                                                                ...
                                                                                @if($roleName == 'Team Leader - MS FABRICATION TEAM' || $roleName == 'Team Leader - SS Fabrication Team' || $roleName == 'Team Leader - FITTING TEAM')
                                                                                    <button class="btn btn-primary btn-sm allocateEmployee mb-1"
                                                                                        style="width:170px;" data-quotationid="{{ $quotation->id }}"
                                                                                        data-productid="{{ $quotationProduct->product_id }}"
                                                                                        data-bom-id="{{ $bom->bom_id }}" data-stage="{{ $bom->stage }}"><i
                                                                                            class="fa fa-user-plus" aria-hidden="true"></i>
                                                                                        Employee</button>
                                                                                    {{-- <button class="btn btn-warning btn-sm addProductionQty btn-sm"
                                                                                        data-datatype="product" style="width:170px"
                                                                                        data-quotationid="{{ $quotation->id }}"
                                                                                        data-quantity="{{ $quotationProduct->quantity }}"
                                                                                        data-productid="{{ $quotationProduct->product_id }}"></i>
                                                                                        Update</button> --}}
                                                                                    <button class="btn btn-warning btn-sm addProductionQty btn-sm"
                                                                                        data-datatype="product" style="width:170px"
                                                                                        data-quotationid="{{ $quotation->id }}"
                                                                                ...
                                                                                @if($roleName == 'Team Leader - Packing Team')
                                                                                    @if($quotationProduct->packing_team_accept_status == 0)
                                                                                        <button class="btn btn-warning btn-sm addProductionQty btn-sm"
                                                                                            data-datatype="product" data-team="packing" style="width:170px"
                                                                                            data-quotationid="{{ $quotation->id }}"
                                                                                            data-quantity="{{ $quotationProduct->quantity }}"
                                                                                            data-productid="{{ $quotationProduct->product_id }}"></i>
                                                                                            Accept</button>
                                                                                ...
                                                                                @endif
                                                                                @if($roleName == 'Team Leader - Dispatch Team')
                                                                                    {{-- <button class="btn btn-primary btn-sm completeProduct btn-sm"
                                                                                        style="width:170px" data-quotationid="{{ $quotation->id }}"
                                                                                        data-productid="{{ $quotationProduct->product_id }}"
                                                                                        data-bom-id="{{ $bom->bom_id }}" data-stage="{{ $bom->stage }}">
                                                                                        Done</button> --}}
                                                                                    <a href="/barcode-print/{{ $quotationProduct->product_id }}"
                                                                                        class="btn btn-primary" style="width:170px;margin-top:10px"><i
                                                                                            class="fa fa-print" aria-hidden="true"></i> &nbsp;&nbsp;
                                                                                        Print</a>
                                                                                @else
                                                                                    {{-- <button class="btn btn-primary btn-sm statusUpdate btn-sm mt-2"
                                                                                        style="width:170px" data-quotationid="{{ $quotation->id }}"
                                                                                        data-productid="{{ $quotationProduct->product_id }}"
                                                                                        data-bom-id="{{ $bom->bom_id }}" data-stage="{{ $bom->stage }}"><i
                                                                                ...
                                                                                @if($roleName == 'Team Leader - PIPE BENDING TEAM')
                                                                                    <button class="btn btn-warning btn-sm addProductionQty btn-sm"
                                                                                        data-datatype="bom" style="width:170px"
                                                                                        data-quotationid="{{ $quotation->id }}"
                                                                                        data-quantity="{{ $quotationProduct->quantity }}"
                                                                                        data-productid="{{ $quotationProduct->product_id }}"></i>
                                                                                        Update</button>
                                                                                ...
                                                                                @if($roleName == 'Team Leader - MS FABRICATION TEAM')
                                                                                    @if(!empty($quotationProduct->ms_fabrication_emp_id))
                                                                                        <span class="badge bg-warning w-100">MS Team :
                                                                                            {{ $quotationProduct?->msFabricationEmployee?->name }}</span>
                                                                                    @endif
                                                                                @endif

                                                                                @if($roleName == 'Team Leader - SS Fabrication Team')
                                                                                    @if(!empty($quotationProduct->ss_fabrication_emp_id))
                                                                                        <span class="badge bg-warning w-100">SS Team :
                                                                                            {{ $quotationProduct?->ssFabricationEmployee?->name }}</span>
                                                                                    @endif
                                                                                @endif
